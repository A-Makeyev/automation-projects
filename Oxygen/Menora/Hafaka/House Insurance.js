...
function loopCount(iterations) {
    for (let i = 1; i <= iterations; i++) {
        try { 
            ...
            obj.click('//ngb-highlight[contains(text(), "22 - טופ לדירה")]')
            ...
            const details = ['6833602', 'ישראל', 'שלום', 'דן', 'דן', '0544987897', '5555']
            ...
            web.pause(2000)
            obj.type('(//span[contains(text(), "קומה")]//..//..//input)[1]', '2')
            obj.type('(//span[contains(text(), "קומה")]//..//..//input)[2]', '4')
            obj.type('(//span[contains(text(), "קומה")]//..//..//input)[3]', '50')
            obj.type('//span[contains(text(), "תאריך ביצוע סקר")]//..//..//input', startDate)
            obj.type('//span[contains(text(), "שם הסוקר")]//..//..//input', '2')
            ...
            obj.type('(//span[contains(text(), "ביטוח מבנה")]//..//..//input)[1]', '500000')
            for (let x = 0; x < 12; x++) {
                if (x == 11) { 
                    for (let y = 0; y < 3; y++) {
                        obj.press_1()
            ...
            obj.type('(//span[contains(text(), "תכולה")]//..//..//input)[1]', '250000')
            obj.type('(//span[contains(text(), "תכשיטים במקיף")]//..//..//input)[1]', '5000')
            obj.type('(//span[contains(text(), "תכשיטים במקיף")]//..//..//input)[2]', '5000')
            ...
            obj.type('(//span[contains(text(), "דגם")]//..//..//input)[1]', 'נוצץ')
            ...
            obj.type('(//span[contains(text(), "תאור המחשב:")]//..//..//input)[1]', 'intel core i7')
